...
def evaluate_coco(img_path, set_name, image_ids, coco, model, threshold=0.5):
    results = []
...
def _eval(coco_gt, image_ids, pred_json_path):
    ...
    # Accessing mAP
    average_precisions = coco_eval.stats

    # mAP at IoU=0.50:0.95, area=all, maxDets=100
    map_50_95 = average_precisions[0]

    # mAP at IoU=0.50, area=all, maxDets=100
    map_50 = average_precisions[1]

    # mAP at IoU=0.75, area=all, maxDets=100
    map_75 = average_precisions[2]

    print('average_precisions', average_precisions)
    print('map_50_95', map_50_95)
    print('map_50', map_50)
    print('map_75', map_75)
    coco_eval.summarize()
